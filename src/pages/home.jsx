...
import tools from '../routesConfig'; // Import the tools list
  ...
  return (
    <div>
      <div>
        <section className="text-center bg-white">
          <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-12">
            ...
            <p className="max-w-xl mx-auto mt-6 text-gray-700 text-pretty text-base/relaxed">
              HandyMan is a collection of free tools and components that can be used in your next project. With a range of tools, you can build your next project faster and more efficiently.
            </p>
            <div className="mt-4">
      ...
      <div className='m-5 lg:mx-28 lg:my-10'>
        <ToolSection tools={filteredTools} />
      </div>
    </div>
  );
}
